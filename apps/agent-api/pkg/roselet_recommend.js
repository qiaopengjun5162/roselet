 ...
 * @returns {string}
 */
function apply_garden_cache_action_wasm(cache_json, action_json) {
    let deferred3_0;
    let deferred3_1;
    try {
...
exports.apply_garden_cache_action_wasm = apply_garden_cache_action_wasm;
 ...
 * @returns {any}
 */
function audio_playback_policy_wasm(input_json) {
...
exports.audio_playback_policy_wasm = audio_playback_policy_wasm;

/**
 * @param {string} rose_id
 * @param {string} content
 * @param {string} ai_reply
 * @param {string} nonce
 * @returns {string}
 */
function build_aleo_vault_inputs_wasm(rose_id, content, ai_reply, nonce) {
    let deferred5_0;
    let deferred5_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(rose_id, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(content, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(ai_reply, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len2 = WASM_VECTOR_LEN;
        const ptr3 = passStringToWasm0(nonce, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len3 = WASM_VECTOR_LEN;
        wasm.build_aleo_vault_inputs_wasm(retptr, ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred5_0 = r0;
        deferred5_1 = r1;
...
exports.build_aleo_vault_inputs_wasm = build_aleo_vault_inputs_wasm;
 ...
 * @returns {string}
 */
function build_garden_url(base_url, page, per_page, color) {
    let deferred3_0;
    let deferred3_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
 ...
 * @returns {any}
 */
function build_optimistic_rose_wasm(plant_body_json, temp_id, now_iso, nickname) {
...
exports.build_optimistic_rose_wasm = build_optimistic_rose_wasm;
 ...
 * @returns {string}
 */
function build_plant_body(color, gratitude, anxiety, hope, is_private, recipient_nickname) {
    let deferred6_0;
    let deferred6_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
exports.build_plant_body = build_plant_body;
 ...
 * @returns {any}
 */
function burstFireworks(cx, cy, count, id_offset) {
    const ret = wasm.burstFireworks(cx, cy, count, id_offset);
    return takeObject(ret);
}
exports.burstFireworks = burstFireworks;

/**
 * @param {string} color
 * @returns {string}
 */
function color_emoji(color) {
    let deferred2_0;
    let deferred2_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
exports.color_emoji = color_emoji;
...
exports.color_label = color_label;
 ...
 * @returns {any}
 */
function compute_layout(screen_json) {
...
exports.compute_layout = compute_layout;
 ...
 * @returns {any}
 */
function compute_pagination(total, page, per_page) {
    const ret = wasm.compute_pagination(total, page, per_page);
    return takeObject(ret);
}
exports.compute_pagination = compute_pagination;
 ...
 * @returns {any}
 */
function compute_sky_params_wasm(hour) {
    const ret = wasm.compute_sky_params_wasm(hour);
    return takeObject(ret);
}
exports.compute_sky_params_wasm = compute_sky_params_wasm;
 ...
 * @returns {any}
 */
function filter_roses(roses_json, color_filter) {
...
exports.filter_roses = filter_roses;
 ...
 * @returns {any}
 */
function format_date_wasm(iso_str) {
...
exports.format_date_wasm = format_date_wasm;
 ...
 * @returns {string}
 */
function format_plant_request_wasm(json) {
    let deferred2_0;
    let deferred2_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
exports.format_plant_request_wasm = format_plant_request_wasm;
 ...
 * @returns {any}
 */
function generate_petals_wasm(count, seed) {
    const ret = wasm.generate_petals_wasm(count, seed);
    return takeObject(ret);
}
exports.generate_petals_wasm = generate_petals_wasm;
 ...
 * @returns {any}
 */
function generate_star_particles_wasm(count, seed) {
    const ret = wasm.generate_star_particles_wasm(count, seed);
    return takeObject(ret);
}
exports.generate_star_particles_wasm = generate_star_particles_wasm;

/**
 * @returns {any}
 */
function getFireworkLaunches() {
    const ret = wasm.getFireworkLaunches();
    return takeObject(ret);
}
exports.getFireworkLaunches = getFireworkLaunches;
 ...
 * @returns {any}
 */
function get_tips_wasm(context) {
...
exports.get_tips_wasm = get_tips_wasm;
 ...
 * @returns {any}
 */
function parse_garden_response_wasm(json) {
    const ptr0 = passStringToWasm0(json, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.parse_garden_response_wasm(ptr0, len0);
    return takeObject(ret);
}
exports.parse_garden_response_wasm = parse_garden_response_wasm;
 ...
 * @returns {any}
 */
function parse_rose_response_wasm(json) {
    const ptr0 = passStringToWasm0(json, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.parse_rose_response_wasm(ptr0, len0);
    return takeObject(ret);
}
exports.parse_rose_response_wasm = parse_rose_response_wasm;
 ...
 * @returns {any}
 */
function rose_to_sound_params_wasm(rose_json) {
...
exports.rose_to_sound_params_wasm = rose_to_sound_params_wasm;
 ...
 * @returns {any}
 */
function store_dispatch(action_json) {
...
exports.store_dispatch = store_dispatch;

/**
 * WASM: 获取当前状态快照
 * @returns {any}
 */
function store_get_snapshot() {
    const ret = wasm.store_get_snapshot();
    return takeObject(ret);
}
exports.store_get_snapshot = store_get_snapshot;
 ...
 * @returns {any}
 */
function validate_feedback_input(json) {
    const ptr0 = passStringToWasm0(json, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.validate_feedback_input(ptr0, len0);
    return takeObject(ret);
}
exports.validate_feedback_input = validate_feedback_input;
 ...
 * @returns {any}
 */
function validate_plant_input(json) {
    const ptr0 = passStringToWasm0(json, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.validate_plant_input(ptr0, len0);
    return takeObject(ret);
}
exports.validate_plant_input = validate_plant_input;
...
const wasmPath = `${__dirname}/roselet_recommend_bg.wasm`;
